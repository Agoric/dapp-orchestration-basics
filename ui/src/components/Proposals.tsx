...
const Proposals = () => {
  ...
  return (
    <div className="flex items-start justify-center space-x-4 p-4">
      {/* Wallet Section */}
      <div className="daisyui-card bg-base-100 w-96 flex-1 shadow-xl">
            ...
            <div>
              ...
              <div>
                ...
                {membershipPurse ? (
                  <ul>
                    {(
                      membershipPurse.currentAmount.value as CopyBag
              ...
              <button
                onClick={() => joinDao(walletConnection)}
                className="daisyui-btn daisyui-btn-primary mt-4"
              >
                Join DAO
              </button>
            </div>
      ...
      <div className="daisyui-card bg-base-100 w-96 flex-1 shadow-xl">
        <div className="daisyui-card-body text-center">
          ...
          {proposals?.map(proposal => (
            <div key={proposal.id} className="mb-4 border-b p-2">
              <h3>{proposal.title.title}</h3>
              <p>{proposal.title.details}</p>
              <button
                onClick={() => voteOnProposal(proposal.id, true)}
                className="daisyui-btn daisyui-btn-primary mr-2"
              >
                Vote For
              </button>
              <button
          ...
          <div>
            ...
            />
            <button
              onClick={() => handleCreateProposal(newTitle, newDetails)}
              className="daisyui-btn daisyui-btn-primary mt-2"
            >
              Create New Proposal
            </button>
          </div>
