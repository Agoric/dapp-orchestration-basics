  ...
  <div className="flex w-full flex-col items-center">
    <div className="w-full p-4">
      <div className={`flex flex-row justify-between items-start space-x-10 border${guidelines ? "" : "-0"}`}>
        <div className={`flex flex-col w-2/3 space-y-10 pr-4 rounded-lg p-4 border${guidelines ? "" : "-0"}`}>
          <h1 className="daisyui-card-title">Accounts</h1>
          {balances.map((balance, idx) => (
            <div key={idx} className={`card bg-base-100 shadow-md p-4 rounded-lg border${guidelines ? "" : "-0"}`}> {/* card */}
              
              
              <p>Address: {balance.address.slice(0, 10)}...{balance.address.slice(-10)}</p>
              {balance.balances.map((bal, idx) => (
                <p key={idx}>{bal.denom}: {bal.amount}</p>
              ))}
              ...
              <div className={`flex flex-col space-y-1 mt-2 border${guidelines ? "" : "-0"}`}>
                ...
                <button
                  className={`inline-flex items-center px-4 py-2 text-sm font-medium text-white ${loadingDeposit ? 'bg-gray-600' : 'bg-gray-800'} border border-gray-700 rounded-l-lg hover:bg-gray-700 hover:text-blue-500 focus:z-10 focus:ring-2 focus:ring-blue-500 focus:text-blue-500`}
                ...
                >
                  ...
                  <button
                      className={`inline-flex items-center px-4 py-2 text-sm font-medium text-white ${loadingWithdraw ? 'bg-gray-600' : 'bg-gray-800'} border-t border-b border-gray-700 hover:bg-gray-700 hover:text-blue-500 focus:z-10 focus:ring-2 focus:ring-blue-500 focus:text-blue-500`}
                    ...
                    <button
                      className={`inline-flex items-center px-4 py-2 text-sm font-medium text-white ${loadingStake ? 'bg-gray-600' : 'bg-gray-800'} border-t border-b border-gray-700 hover:bg-gray-700 hover:text-blue-500 focus:z-10 focus:ring-2 focus:ring-blue-500 focus:text-blue-500`}
                      onClick={handleStake}
                    ...
                    <button
                      className={`inline-flex items-center px-4 py-2 text-sm font-medium text-white ${loadingUnstake ? 'bg-gray-600' : 'bg-gray-800'} border border-gray-700 rounded-r-lg hover:bg-gray-700 hover:text-blue-500 focus:z-10 focus:ring-2 focus:ring-blue-500 focus:text-blue-500`}
